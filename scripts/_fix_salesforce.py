"""Re-download Salesforce grounding images."""
from datasets import load_dataset
from pathlib import Path
import json
from PIL import Image

out_dir = Path('/scratch/gz27/nanogui/datasets/salesforce_grounding')
images_dir = out_dir / 'images'
images_dir.mkdir(parents=True, exist_ok=True)

print('Loading Salesforce grounding...')
ds = load_dataset('Salesforce/grounding_dataset')
...
print(f'Total Salesforce images: {count}')
